...
public interface BaseMapper<T> {
    ...
    List<Map<String, Object>> querySqlResultMap(@Param(PARAM_OBJECT) YiliBaseSql<T> querySql);
    ...
    @SelectProvider(method = "querySqlOne", type = BaseSqlProvider.class)
    @ResultType(Map.class)
    Map<String, Object> querySqlResultMapOne(@Param(PARAM_OBJECT) YiliBaseSql<T> querySql);
